...
// Start of standard v.5.6.4-4ubuntu6.2
 ...
 * always wrapped at or before the specified <i>width</i>. So if you have
 * a word that is larger than the given width, it is broken apart.
 * (See second example). When <b>FALSE</b> the function does not split the word
 * even if the <i>width</i> is smaller than the word width.
 * </p>
 ...
 * </table>
 * </p>
 * @param string $encoding [optional] An optional argument defining the encoding used when converting characters.
 * </p>
 * If omitted, the default value of the <i>encoding</i> varies
 ...
 * </p>
 * @return mixed If <i>spool</i> is less than 2, the JPEG will be returned,
 * or <b>FALSE</b> on failure. Otherwise returns <b>TRUE</b> on success
 ...
 * </p>
 * <p>
 * When a <i>start</i> parameter is set, the returned length
 ...
 * </p>
 * @return int the length of the initial segment of <i>subject</i>
 * which consists entirely of characters not in <i>mask</i>.
 * </p>
 * <p>
 * When a <i>start</i> parameter is set, the returned length
 * is counted starting from this position, not from the beginning of
 ...
 * <i>main_str</i>, or the <i>length</i> is
 * set and is less than 1 (prior to PHP 5.6),
 * <b>substr_compare</b> prints a warning and returns
 * <b>FALSE</b>.
 */
 ...
 * beyond, <b>FALSE</b> will be returned.
 * </p>
 * <p>
 ...
 * </code>
 * @return string the extracted part of <i>string</i>; or <b>FALSE</b> on failure, or
 * an empty string.
 */
 ...
 * The optional <i>delimiters</i> contains the word separator characters.
 * </p>
 ...
 * XHTML tag to strip these from <i>str</i>. For example,
 ...
 * takes place, and <i>input</i> will be returned.
 * </p>
 ...
 * <b>mt_rand</b> without arguments, which is the maximum value
 * that can be used for its <i>max</i> parameter without the
 ...
 * </p>
 * @return string the uuencoded data or <b>FALSE</b> on failure.
 */
 ...
 * </p>
 * As of PHP 5.6.1 can also be specified as <b>INI_SCANNER_TYPED</b>.
 * In this mode boolean, null and integer types are preserved when possible.
 * String values "true", "on" and "yes"
 * are converted to <b>TRUE</b>. "false", "off", "no"
 * and "none" are considered <b>FALSE</b>. "null" is converted to <b>NULL</b>
 ...
 * the case.
 * </p>
 * @return bool <b>TRUE</b> if <i>var</i> is callable, <b>FALSE</b>
 * otherwise.
 */
 ...
 * In this mode, <b>fseek</b> only affects
 ...
 * create it. In this mode, <b>fseek</b> only affects
 * the reading position, writes are always appended.
 * </td>
 * </tr>
 * <tr valign="top">
 ...
 * writing. In other words, a <b>flock</b> call happens
 * between the <b>fopen</b> call and the
 * <b>fwrite</b> call. This is not identical to an
 * <b>fopen</b> call with mode "x".
 * </td>
 * </tr>
 * </table>
 * </p>
 ...
 * </p>
 * @param string $delimiter [optional] <p>
 * The optional <i>delimiter</i> parameter sets the field delimiter (one character only).
 * </p>
 * @param string $enclosure [optional] <p>
 * The optional <i>enclosure</i> parameter sets the field enclosure character (one character only).
 * </p>
 * @param string $escape [optional] <p>
 * The optional <i>escape</i> parameter sets the escape character (one character only).
 * </p>
 * @return array an indexed array containing the fields read.
 * </p>
 * <p>
 ...
 * The optional <i>escape_char</i> parameter sets the
 ...
 * </p>
 * <p>
 * For case-insensitive filesystems <b>realpath</b> may or may
 ...
 * </p>
 * <p>
 * <i>additional_headers</i> does not have mail header
 ...
 * @return int the length of the output buffer contents, in bytes, or <b>FALSE</b> if no
 * buffering is active.
 */
 ...
 * </p>
 * @return mixed <b>min</b> returns the parameter value considered "lowest" according to standard
 ...
 * An array containing the values.
 * </p>
 * @return mixed <b>max</b> returns the parameter value considered "highest" according to standard
 * comparisons. If multiple values of different types evaluate as equal (e.g. 0
 * and 'abc') the first provided to the function will be returned.
 */
 ...
 * the end of the array. If <i>length</i> is
...
/**
 * <b>ARRAY_FILTER_USE_BOTH</b> is used with
 * <b>array_filter</b> to pass both value and key to the given callback function.
 * Added in PHP 5.6.0.
 * @link http://php.net/manual/en/array.constants.php
 */
...
/**
 * <b>ARRAY_FILTER_USE_KEY</b> is used with
 * <b>array_filter</b> to pass each key as the first argument to the given callback function.
 * Added in PHP 5.6.0.
 * @link http://php.net/manual/en/array.constants.php
 */
...
// End of standard v.5.6.4-4ubuntu6.2
?>
